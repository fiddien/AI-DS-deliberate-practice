...
![[attachments/Pasted image 20211130073923.png]]
...
![[attachments/Pasted image 20211130075827.png]]
...
![[attachments/Pasted image 20211130081800.png]]
...
![[attachments/Pasted image 20211130082833.png]]
...
Representasi A: Secara sederhana memodelkan kotak sebagai titik (*node*) di graf lalu menghubungkan setiap titik, sehingga graf Tick Tack Toe A kita adalah graf lengkap.

![[attachments/Pasted image 20211130082910.png]]
...
![[attachments/Pasted image 20211130082933.png]]
...
![[attachments/Pasted image 20211130084528.png]]

Tapi ada beberapa *langkah* yang tidak berguna atau bodoh, seperti ini contohnya:

![[attachments/Pasted image 20211130084654.png]]
...
![[attachments/Pasted image 20211130085103.png]]
...
- Mobil di C. Ia terpaksa harus membuka B. (A tidak mungkin dibuka karena itu pilihan kita). Artinya,
	- P(B dibuka|mobil di C) = 1,
	- P(B dibuka|mobil di 0) = 0.
...
Untuk tujuan produktif kita, kita harus mendefinisikan *kecerdasan* *sesuatu* bukanlah berasal dari bagaimana kita mempersepsikan *sesuatu*, tapi harus dari sesuatu yang datang dari sistem *sesuatu*nya itu sendiri.
...
![[attachments/Pasted image 20211130111916.png]]
